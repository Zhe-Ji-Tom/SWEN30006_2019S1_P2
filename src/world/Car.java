...
public class Car extends Sprite{
	...
	public boolean checkHistoryTrack(Coordinate tracks) {
		if(historyMaps.contains(tracks)){
			return true;
		}else {
			historyMaps.add(tracks);
			return false;
		}
	}

	public void setHistoryMaps(Coordinate subHistoryMaps) {
		historyMaps.add(subHistoryMaps);
	}

	private HashSet<Coordinate> historyMaps = new HashSet<>();
